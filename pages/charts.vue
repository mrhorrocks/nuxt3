<template>
    ...
    <section aria-label="Chartjs Examples">
        <h3 class="section-title"><a href="https://www.chartjs.org/">Chartjs Examples</a></h3>
    ...
    <section aria-label="Google Charts Examples">
        <h3 class="section-title"><a href="https://developers.google.com/chart">Google Charts Examples</a></h3>
        <div class="lg:grid grid-cols-3">
            <div class="col-span-2 lg:pr-32">
                <h3 class="chart-title">UK sunlight hours per month</h3>
                <GoogleBarChart />
